...
## Migrations
- Create, seedm and apply schema changes
...
If the schema changes before commiting the migration you can re-scaffold the migration byu running <code>add-migration InitialCreate</code> again.
